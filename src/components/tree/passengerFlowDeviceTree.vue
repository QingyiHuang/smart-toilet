...
export default {
  ...
  methods: {
    ...
    queryData() {
      ...
      // this.queryCommon('transport', 'companyList', this.pager).then(res => {
      //   const { list, total } = res.data;
      //   this.total = total;
      //   this.optionData = (list || []).map(node => {
      //     return {
      //       parentId: node.companyDTO.orgIndexCode,
      //       name: node.companyDTO.companyName,
      //       code: node.relatedIndexCode,
      //       director: node.companyDTO.operationManager,
      //       directorTel: node.companyDTO.phoneNumber
      //     };
      //   });
      // });
    },
