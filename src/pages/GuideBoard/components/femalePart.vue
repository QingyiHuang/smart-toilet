...
.malePart {
  ...
  .toiletInfo {
    ...
    .toiletInfoLeft {
      ...
      &::before {
        content: '';
        background: url('~@/assets/images/databoard/icon-女厕02.png') no-repeat;
        background-size: 100% 100%;
        width: 100px;
        height: 100px;
        left: 0;
      ...
      &::after {
        content: '';
        background: url('~@/assets/images/databoard/icon-女厕03.png') no-repeat;
        background-size: 100% 100%;
        width: 100px;
        height: 100px;
        left: 0;
